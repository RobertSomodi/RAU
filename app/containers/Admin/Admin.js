  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        ></AppBar>
        <Drawer
          userRole={this.props.auth_user.data.roleId==1 ? 'admin':'user'}
          open={this.state.open}
          handleDrawerState={this.handleDrawerState}
        ...
        <main className={classes.content}>
          ...
          <Switch>
            ...
            <Route
              path={`${path}/positions/edit/:id`}
              component={ManagePosition}
            />
            <Route
              path={`${path}/positions/view/:id`}
              component={ManagePosition}
            />
            <Route exact path={`${path}/departments`} component={Departments} />
            <Route
              path={`${path}/departments/add/`}
            ...
            <Route
              exact
              path={`${path}/shift-frequency`}
              component={ReportShiftFrequency}
            />
